...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("gd-haxe", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("gd-haxe", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "gd-haxe";
		app.meta["name"] = "Geometry Dash Recreation";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: false,
			title: "Geometry Dash Recreation",
			width: 1280,
			x: null,
			y: null,
		};
